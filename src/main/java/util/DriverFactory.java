...
public class DriverFactory {
    ...
    public static AppiumDriver initialize_Driver(String browser){
        ...
        if(browser.equals("Android")){
            ...
            capabilities.setCapability("udid","emulator-5554");//burada deviceName ile ayni anlama geliyor dedi(?)
        ...
        try {
            driver = new AppiumDriver(new URL("http://0.0.0.0:4723/wd/hub"), capabilities);//bu Url appiumun ozelmis
